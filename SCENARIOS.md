...
| 6 | CLI validation | `cli_validation_test.go` | `pgpipe listen` errors on missing --db, missing --channel, unknown adapter, webhook without --url, tx flags without WAL | N/A (all failure paths) |
